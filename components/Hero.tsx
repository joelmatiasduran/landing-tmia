...
const Hero: React.FC = ({}) => {
  return (
    <>
      <div className="flex flex-col items-center justify-center md:mt-24 pt-14 w-full min-w-full ">
        <div className="flex flex-col-reverse md:flex-row w-full min-w-full">
          <div className="w-full md:w-3/6">
            <div className="md:pl-44 pr-38 py-24">
              ...
              <p className="text-2xl mt-8 max-w-4xl text-gray-400 text-center md:text-left">
